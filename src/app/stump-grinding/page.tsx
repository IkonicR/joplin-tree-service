...
export const metadata: Metadata = {
  title: 'Stump Grinding Joplin | Deep Root Removal',
  description: 'Complete stump removal and grinding services in Joplin. We grind stumps below grade so you can replant. Affordable and fast service.',
  alternates: {
