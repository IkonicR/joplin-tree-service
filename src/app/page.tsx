...
import { Phone, CheckCircle2, ArrowRight, ShieldCheck, Clock, Trees } from "lucide-react";
   ...
   return (
      <div className="flex min-h-screen flex-col bg-stone-50 font-sans selection:bg-green-200 selection:text-green-900">
         ...
         <main className="flex-1">
            ...
            <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden bg-stone-900 pb-24">
               ...
               <div className="container relative z-10 px-6 mx-auto text-center md:text-left pt-44 md:pt-32">
            ...
            <div className="relative z-0 bg-green-950 text-white py-12 border-b border-white/5">
