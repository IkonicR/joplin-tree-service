...
export const metadata: Metadata = {
  title: '24/7 Emergency Tree Service Joplin | Storm Damage',
  description: '24/7 Emergency tree removal and storm damage cleanup in Joplin, MO. We handle trees on houses, cars, and driveways. Immediate response available.',
  alternates: {
        ...
        <section className="py-24 bg-white text-center">
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <p className="text-xl text-stone-600 mb-10 leading-relaxed">
              Do not attempt to remove storm debris near power lines. Electricity can arc through wet wood. Call Liberty Utilities or Empire District Electric to cut power, then call us.
            </p>
