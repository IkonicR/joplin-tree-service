...
export const metadata: Metadata = {
  title: 'Joplin Tree Care Blog | Expert Advice & Local Guides',
  description: 'Expert tree care advice for Joplin homeowners. Learn about local pests, tree removal costs, and seasonal maintenance.',
};
        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl text-stone-600">
              Expert advice for Jasper County homeowners. From ordinances to oak wilt, we cover it all.
            </p>
          </div>
