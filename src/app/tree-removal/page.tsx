...
export const metadata: Metadata = {
   title: 'Hazardous Tree Removal Joplin, MO | Precision Takedowns',
   description: 'Expert tree removal service in Joplin. We safely remove large, hazardous, and storm-damaged trees using cranes and rigging. Zero-impact lawn protection.',
   alternates: {
            ...
            <section className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden bg-stone-900">
               ...
               <div className="container relative z-10 px-6 mx-auto text-center pt-44 md:pt-24">
                  ...
                  <p className="text-xl text-stone-300 mb-10 max-w-2xl mx-auto font-light leading-relaxed">
                     We specialize in the difficult jobs. Removing massive Oaks over houses, navigating power lines, and zero-impact rigging in tight spaces.
                  </p>
