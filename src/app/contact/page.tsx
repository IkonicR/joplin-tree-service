...
import { PHONE_HREF, PHONE_NUMBER, SERVICE_AREA } from '@/lib/constants';
import { PhoneLink } from '@/components/phone-link';

export const metadata: Metadata = {
  title: 'Contact Joplin Tree Service | Free Estimates',
  description: 'Contact us for a free tree service estimate in Joplin, MO. Call now or fill out our online form. Fast response for tree removal and trimming.',
  alternates: {
    canonical: '/contact',
  },
};
              ...
              <div className="grid gap-8">
                <div className="flex items-start gap-6 p-6 bg-stone-50 border border-stone-100 rounded-lg hover:border-stone-200 transition-colors">
                  ...
                  <div>
                    ...
                    <PhoneLink href={PHONE_HREF} className="text-2xl font-black text-stone-900 hover:text-green-600 transition-colors">{PHONE_NUMBER}</PhoneLink>
                  </div>
                </div>
