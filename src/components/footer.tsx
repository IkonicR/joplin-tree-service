...
import { Trees, Phone, MapPin, Facebook, Instagram, ShieldCheck } from "lucide-react";
import { COMPANY_NAME, PHONE_NUMBER, PHONE_HREF, ADDRESS } from "@/lib/constants";
...
export function Footer() {
  ...
  return (
    <footer className="bg-stone-950 text-stone-300 border-t border-white/10 font-sans">
      ...
      <div className="container mx-auto px-6 py-16 grid lg:grid-cols-4 gap-12 border-b border-white/5">
        ...
        <div>
          ...
          <ul className="grid grid-cols-2 gap-x-4 gap-y-4 text-sm text-stone-400">
            <li><Link href="/" className="hover:text-green-400 transition-colors">Joplin, MO</Link></li>
            <li><Link href="/service-areas/webb-city" className="hover:text-green-400 transition-colors">Webb City</Link></li>
            <li><Link href="/service-areas/carl-junction" className="hover:text-green-400 transition-colors">Carl Junction</Link></li>
            <li><Link href="/service-areas/oronogo" className="hover:text-green-400 transition-colors">Oronogo</Link></li>
            <li><Link href="/service-areas/carterville" className="hover:text-green-400 transition-colors">Carterville</Link></li>
            <li><span className="hover:text-stone-200 cursor-default opacity-50">Duquesne (Coming Soon)</span></li>
            <li><span className="hover:text-stone-200 cursor-default opacity-50">Leawood (Coming Soon)</span></li>
            <li><span className="hover:text-stone-200 cursor-default opacity-50">Saginaw (Coming Soon)</span></li>
          </ul>
        </div>
          ...
          <ul className="space-y-6 text-sm">
            <li className="flex items-start gap-4">
              ...
              <div>
                ...
                <PhoneLink href={PHONE_HREF} className="text-xl font-bold text-white hover:text-green-400 transition-colors block">{PHONE_NUMBER}</PhoneLink>
              </div>
            </li>
            <li className="flex items-start gap-4">
              <MapPin className="h-5 w-5 text-green-500 shrink-0 mt-0.5" />
              <span className="leading-relaxed text-stone-400">{ADDRESS} <br /> Jasper & Newton Counties</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="bg-stone-950 py-8 pb-20 md:pb-8 border-t border-white/5">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-stone-500">
          <div className="flex items-center gap-6">
            ...
            <span>|</span>
            <span>Ordinance 2008-212 Compliant</span>
          </div>
